...
137,443 & \myind{机关}       & 发射射弹 \\\hline
141     & \myind{炸药}       & 爆炸（一次性） \\\hline
210     & \myind{地雷}       & 爆炸（一次性） \\\hline
  ...
  \subfloat[]{
    ...
    \begin{tikzpictureC}[scale=0.5, transform shape]
      ...
      \foreach \x in {0,...,9} {
        ...
        \bitsetSetDec{bits}{\x}
        \bitsetXor{bits}{mask}
        \pgfmathsetmacro{\gatex}{\x+6}
        \placeAndGate{\bitsetGetBin{bits}{4}1}{\gatex}{8}
        \placeAndGate{0}{\gatex}{5}
        \placeAndGate{01}{\gatex}{1}
      }
