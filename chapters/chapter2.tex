...
回顾\nameref{sec14}，它可以把火把的值设定为一个常数，而该常数可以通过故障逻辑门上的有效逻辑灯来调节。而在\autoref{i237:238}中，我们让左边的火把来调节故障逻辑门上的有效逻辑灯，当左边火把为1时，故障逻辑门变成了置1电路；当左边火把为0时，故障逻辑门变成了置0电路。这样一来，这个故障逻辑门的功能实际上是把右边火把的值置为左边火把的值。
