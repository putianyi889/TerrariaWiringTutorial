...
\begin{figure}[!ht]
  ...
  \subfloat[]{
    ...
    \begin{tikzpictureC}[TRsch]
      \placetile{Switch_Flat_Off}{0}{0}
      \placetile{Torch_On}{5}{0}
      \draw[red wire] (0,0) -- (5,0);
    \end{tikzpictureC}
  }%
  \smarthfill{12}%
...
\begin{example}{逐线步进}{}
  ...
  \begin{center}
    \begin{tikzpictureC}[TRsch]
      \placetile{Switch_Flat_Off}{0}{0}
      \placetiles{Torch_On}{0/5,5/0,-5/0,0/-5}
      \draw[red wire] (0,0) -- (0,5);
      \draw[blue wire] (0,0) -- (5,0);
      \draw[green wire] (0,0) -- (0,-5);
      \draw[yellow wire] (0,0) -- (-5,0);
    \end{tikzpictureC}
  \end{center}
...
\begin{example}{逐逻辑帧步进}{}
  ...
  \begin{center}
    \begin{tikzpictureC}[TRsch]
      \placetile{Switch_Flat_Off}{-2}{1}
      \placeAndGate{0}{0}{0}
      \placeAndGate{0}{2}{0}
      \placeAndGate{0}{4}{0}
      \placeAndGate{0}{6}{0}
      \placeAndGate{0}{8}{0}
      \placetile{Torch_On}{10}{0}
      \draw[red wire] (-2,1) -- (0,1);
      \draw[blue wire] (0,0) -- (1,0) -- (1,1) -- (2,1);
      \draw[red wire] (2,0) -- (3,0) -- (3,1) -- (4,1);
      \draw[blue wire] (4,0) -- (5,0) -- (5,1) -- (6,1);
      \draw[red wire] (6,0) -- (7,0) -- (7,1) -- (8,1);
      \draw[blue wire] (8,0) -- (10,0);
    \end{tikzpictureC}
  \end{center}
...
\begin{figure}[!ht]
  ...
  \subfloat[横式]{%
    \begin{tikzpictureC}[TRsch]
      ...
      \draw[red wire] (-2,1) -- (0,1);
      \draw[blue wire] (0,0) -- (1,0) -- (1,1) -- (2,1);
      \draw[green wire] (2,0) -- (3,0) -- (3,1) -- (4,1);
      \draw[yellow wire] (4,0) -- (5,0) -- (5,1) -- (6,1);
    \end{tikzpictureC}
  }%
  \smarthfill{31}[5]%
  \subfloat[竖式]{%
    ...
    \begin{tikzpictureC}[TRsch]
      ...
      \placeAndGate{0}{0}{2}
      \placeAndGate{0}{0}{4}
      \draw[red wire] (0,6) -- (0,5);
      \draw[blue wire] (0,4) -- (0,3);
      \draw[green wire] (0,2) -- (0,1);
      \draw[yellow wire] (0,0) -- (0,-1);
    \end{tikzpictureC}%
    \quad
  }%
  \smarthfill{31}[5]%
  \subfloat[斜式]{%
    \begin{tikzpictureC}[TRsch]
      ...
      \placeAndGate{0}{1}{1}
      \placeAndGate{0}{2}{0}
      \draw[red wire] (-1,3) -- (0,3);
      \draw[blue wire] (0,2) -- (1,2);
      \draw[green wire] (1,1) -- (2,1);
  ...
  \subfloat[双竖式]{%
    ...
    \begin{tikzpictureC}[TRsch]
      ...
      \placeAndGate{0}{1}{1}
      \placeAndGate{0}{0}{2}
      \draw[red wire] (0,3) -- (1,3);
      \draw[blue wire] (0,2) -- (1,2);
      \draw[green wire] (0,1) -- (1,1);
      \draw[yellow wire] (0,0) -- (1,0);
    \end{tikzpictureC}%
    \quad
  }%
  \smarthfill{31}[5]%
  \subfloat[紧凑横式]{%
    ...
    \begin{tikzpictureC}[TRsch]
      ...
      \placeAndGate{0}{1}{0}
      \placeAndGate{0}{2}{0}
      \draw[red wire] (-1,1) -- (0,1);
      \draw[blue wire] (0,0) -- (0,1) -- (1,1);
      \draw[green wire] (1,0) -- (1,1) -- (2,1);
      \draw[yellow wire] (2,0) -- (2,1) -- (3,1);
    \end{tikzpictureC}%
    \quad
  }
  \caption{逻辑延迟器的不同摆法，逻辑延迟均为3个逻辑帧。紧凑横式利用了爆门。紧凑横式需要三种电线颜色，其他都只需要两种。}
  \label{i153:156}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \subfloat[]{%
    ...
    \begin{tikzpictureC}[TRsch]
      ...
      \draw[red wire] (0,0) -- (1,0) -- (1,1) -- (2,1) -- (2,2);
      \draw[blue wire] (2,0) -- (3,0);
  ...
  \subfloat[]{%
    ...
    \begin{tikzpictureC}[TRsch]
      ...
      \draw[blue wire] (2,0) -- (3,0);
      \node[right] at (3.5,0.5) {输出};
      \draw[green wire] (2,2) -- (3,2);
      \node[right] at (3.5,2.5) {控制};
    \end{tikzpictureC}
  }%
  \smarthfill{17}[3]%
  \subfloat[]{%
    \label{fig47}%
    \begin{tikzpictureC}[TRsch]
      \placeAndGate{011}{0}{0}
      \placeAndGate{0}{1}{2}
      \draw[green wire] (0,3) -- (1,3) -- (1,2) -- (2,2);
      \node[right] at (2.5,2.5) {控制};
      \draw[blue wire] (0,0) -- (1,0);
      \node[right] at (1.5,0.5) {输出};
    \end{tikzpictureC}
  }
  \caption{\protect\subref{fig45}与门从灭变亮时输出，从亮变灭不输出。\protect\subref{fig46}与门亮时激活绿线才能产生输出。\protect\subref{fig47}双激活技术，当下面两灯全亮时激活绿线会产生一个输出。}\label{fig44}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \subfloat[]{%
    ...
    \begin{tikzpictureC}[TRsch]
      ...
      \node[left] at (-1.5,3.5) {只输入红};
      \node[left] at (-1.5,1.5) {只输入蓝};
      \node[left] at (-1.5,2.5) {同时输入};
      \draw[green wire] (1,0) -- (2,0);
      \node[right] at (2.5,0.5) {输出};
    \end{tikzpictureC}
  }%
  \smarthfill{18}%
  \subfloat[]{%
    ...
    \begin{tikzpictureC}[TRsch]
      ...
      \node[left] at (-1.5,2.5) {只输入蓝};
      \node[left] at (-1.5,0.5) {只输入红};
      \node[left] at (-1.5,1.5) {同时输入};
      \draw[green wire] (1,0) -- (2,0);
      \node[right] at (2.5,0.5) {输出};
    \end{tikzpictureC}
  }
  \caption{只有在同一个逻辑帧激活红蓝，才会产生输出。}
  \label{i138:141}
\end{figure}

例如\autoref{i138:141}中的两个电路，只当蓝线和红线在一个逻辑帧激活时，右侧的逻辑门才会激活。换个思路，也可以认为这里的一根线对另一根线实现了精确到逻辑帧的信号检测。这两个电路也有细微差别。故障逻辑门上的有效逻辑灯是灭的情况下故障逻辑灯怎么激活都不会爆门，而双激活电路是一次性的，所以\autoref{i138:139}的输出条件实际上是蓝线与红线的第一次激活在同一个逻辑帧；\autoref{i140:141}的输出条件是红线第一次激活的同一个逻辑帧蓝线也激活。
...
\begin{figure}[!ht]
  ...
  \begin{tikzpictureC}[TRsch]
    \placetile{Switch_Flat_Off}{0}{0}
    \placetiles{Dart_Trap_U}{2/0,4/0}
    \placetiles{Smooth_Marble_Block}{2/5,4/5}
    \placeTealPressurePad{T}{2}{4}
    \placeTealPressurePad{T}{4}{4}

    \draw[red wire] (0,0) -- (4,0);
  \end{tikzpictureC}
  \caption{}
  \label{i167:168}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpictureC}[TRsch]
    ...
    \placeTealPressurePad{T}{4}{4}
    \placeFaultyGate{20}{7}{2}
    \placeFaultyGate{21}{9}{2}
    \placetiles{Torch_On}{7/0,9/0}

    \draw[red wire] (0,0) -- (4,0);
    \draw[blue wire] (4,4) -- (4,3) -- (9,3);
    \draw[green wire] (2,4) -- (2,5) -- (6,5) -- (6,4) -- (9,4);
    \draw[yellow wire] (7,0) -- (7,2);
    \draw[yellow wire] (9,0) -- (9,2);
  \end{tikzpictureC}
  \caption{}
  \label{i169:170}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpictureC}[TRsch]
    ...
    \draw[red wire] (0,0) -- (4,0);
    \draw[blue wire] (4,4) -- (7,4);
    \draw[green wire] (2,4) -- (2,3) -- (7,3);
    \draw[yellow wire] (7,2) -- (8,2) -- (8,3) -- (9,3) -- (9,4);
    \draw[red wire] (9,0) -- (9,2);
  \end{tikzpictureC}
  \caption{}
