...
\begin{center}
  \adjincludegraphics{textures/item/Heart_Statue.png}
  \adjincludegraphics{textures/item/Star_Statue.png}
...
\begin{center}
  \adjincludegraphics{textures/item/King_Statue.png}
...
\subsection{其他雕像}
\begin{center}
  \adjincludegraphics{textures/item/Boulder_Statue.png}
...
\begin{figure}[!ht]
  ...
  \subfloat[]{\label{fig92}
    \begin{tikzpictureC}[scale=0.5, transform shape, x=16pt, y=16pt]
