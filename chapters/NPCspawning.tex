...
\begin{figure}[!ht]
    ...
    \subfloat[进化兽]{\quad\includegraphics{npcs/Evolution_Beast.png}\quad}
    \subfloat[预言帝]{\quad\includegraphics{npcs/Predictor.png}\quad}
    \caption{星云柱}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \subfloat[异星黄蜂]{\quad\includegraphics{npcs/Alien_Hornet.png}\quad}
    \subfloat[星旋怪]{\quad\includegraphics{npcs/Vortexian.png}\quad}
    \caption{星旋柱}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \subfloat[流体入侵怪]{\quad\includegraphics{npcs/Flow_Invader.png}\quad}
    \subfloat[闪耀炮手]{\quad\includegraphics{npcs/Twinkle_Popper.png}\quad}
    \subfloat[观星怪]{\quad\includegraphics{npcs/Stargazer.png}\quad}
    \caption{星尘柱}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \subfloat[火龙怪骑士]{\quad\includegraphics{npcs/Drakomire_Rider.png}\quad}
    \subfloat[火滚怪]{\quad\includegraphics{npcs/Sroller.png}\quad}\\
    \subfloat[流星火怪]{\quad\includegraphics{npcs/Corite.png}\quad}
    \subfloat[火月怪]{\quad\includegraphics{npcs/Selenian.png}\quad}
    \subfloat[火龙战士]{\quad\includegraphics{npcs/Drakanian.png}\quad}
    \caption{日曜柱}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \subfloat[鸟妖]{\quad\includegraphics{npcs/Harpy.png}\quad}\\
    \subfloat[飞龙]{\quad\includegraphics{npcs/299px-Wyvern.png}\quad}
    \caption{太空刷怪}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \subfloat[哥布林弓箭手]{\qquad\includegraphics{npcs/Goblin_Archer.png}\qquad}
    \subfloat[哥布林盗贼]{\qquad\includegraphics{npcs/Goblin_Thief.png}\qquad}
    \subfloat[哥布林战士]{\qquad\includegraphics{npcs/Goblin_Warrior.png}\qquad}
    \subfloat[哥布林召唤师]{\qquad\includegraphics{npcs/Goblin_Summoner.png}\qquad}
    \caption{哥布林入侵}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \subfloat[戳刺先生]{\quad\includegraphics{npcs/Mister_Stabby.png}\quad}
    \caption{雪人入侵}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \subfloat[海盗神射手]{\quad\includegraphics{npcs/Pirate_Deadeye.png}\quad}
    \subfloat[私船海盗]{\quad\includegraphics{npcs/Pirate_Corsair.png}\quad}
    \subfloat[海盗水手]{\quad\includegraphics{npcs/Pirate_Deckhand.png}\quad}
    \subfloat[海盗船长]{\quad\includegraphics{npcs/Pirate_Captain.png}\quad}\\
    \subfloat[荷兰飞盗船]{\quad\includegraphics{npcs/260px-Flying_Dutchman.png}\quad}
    \caption{海盗入侵}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \subfloat[鳞甲怪]{\quad\includegraphics{npcs/Scutlix.png}\quad}\\
    \subfloat[火星工程师]{\qquad\includegraphics{npcs/Martian_Engineer.png}\qquad}
    \subfloat[火星飞船]{\includegraphics{npcs/Martian_Drone.png}}
    \subfloat[扰脑怪]{\quad\includegraphics{npcs/Brain_Scrambler.png}\quad}
    \subfloat[激光枪手]{\qquad\includegraphics{npcs/Ray_Gunner.png}\qquad}
    \subfloat[灰咕噜兽]{\qquad\includegraphics{npcs/Gray_Grunt.png}\qquad}
    \subfloat[电击怪]{\quad\includegraphics{npcs/Gigazapper.png}\quad}
    \subfloat[火星军官]{\quad\includegraphics{npcs/Martian_Officer.png}\quad}
    \caption{火星入侵}
\end{figure}
