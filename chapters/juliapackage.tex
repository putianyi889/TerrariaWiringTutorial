...
\section{\texorpdfstring{$\mathbb{Z}_2$}{Z\textbackslash 2}相关功能}
\begin{lstlisting}[language=Julia, style=julia]
...
\subsection{\texorpdfstring{$\mathbb{Z}_2$}{Z\textbackslash 2}向量}
\begin{lstlisting}[language=Julia, style=julia]
...
\subsection{\texorpdfstring{$\mathbb{Z}_2$}{Z\textbackslash 2}矩阵}
\begin{lstlisting}[language=Julia, style=julia]
