...
\github{TEdit/Terraria-Map-Editor} | \href{http://www.binaryconstruct.com/downloads/}{下载1} | 推荐教程\youku{XMjYxNTUzOTMyOA}\youku{XMjY0NDYwMTM3Ng}\youku{XMjY1OTIzNjg4OA}\youku{XMjY3ODQwODE1Ng}

\section{模组}
\begin{itemize}
\item[tModLoader]\label{app4} \href{https://www.tmodloader.net/}{官网} | \github{tModLoader/tModLoader}
\item[CheatSheet]\label{app5} \github{JavidPack/CheatSheet}\trforum{41407} | \href{http://javid.ddns.net/tModLoader/download.php?Down=mods/CheatSheet.tmod}{备用下载}
\item[HERO's Mod]\label{app6} \github{JavidPack/HEROsMod}\trforum{44650} | \href{http://javid.ddns.net/tModLoader/download.php?Down=mods/HEROsMod.tmod}{备用下载}
\item[MechScope]\label{app7} \github{DRKV333/MechScope}\trforum{70665}\bilibili[read]{cv2222687}
\end{itemize}

\section{源码}\label{app8}
1.3.5及1.4各版本\github{Pryaxis/Sources} | 1.3.2.1\github{NoviaDroid/TerrariaRefractoring\_1.3.2.1} | 1.3\github{saniainf/EDTerraria} | 1.2.4.1\github{EdgeKiller/terrariaSource} | 1.2.0.3.1\github{TheVamp/Terraria-Source-Code} | Xbox 360\github{dptug/TerrariaXDK}
