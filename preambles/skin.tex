...
\if\rendermode3
  ...
  \definecolor{thmcolback}{named}{black}
  \definecolor{thmcoltext}{named}{lightgray}

  \definecolor{vipcolback}{named}{black}
  \definecolor{vipcoltext}{named}{lightgray}

  \definecolor{redcolframe}{named}{redwiredarkborder}
  \definecolor{bluecolframe}{named}{bluewiredarkborder}
  \definecolor{greencolframe}{named}{greenwiredarkborder}
  \definecolor{yellowcolframe}{named}{yellowwiredarkborder}
\else
  \definecolor{thmcolback}{named}{white}
  \definecolor{vipcolback}{named}{white}

  \definecolor{thmcoltext}{named}{black}
  \definecolor{vipcoltext}{named}{black}

  \definecolor{redcolframe}{named}{redwiremiddle}
  \definecolor{bluecolframe}{named}{bluewiremiddle}
  \definecolor{greencolframe}{named}{greenwiremiddle}
  \definecolor{yellowcolframe}{named}{yellowwiremiddle}
\fi