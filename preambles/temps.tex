...
\newcommand{\wiki}[2][]{\myhref{https://terraria.wiki.gg/zh/wiki/#2}{\ifstrempty{#1}{#2}{#1}}}
...
\NewDocumentCommand{\calchspace}{mm}{\maxof{0pt}{\minof{\maxof{2em}{#1/#2/2}}{(\linewidth-#1)/#2}}-8pt}
\newlength{\tiledim}
