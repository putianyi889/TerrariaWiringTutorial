...
\if\rendermode1
	...
	\newcommand{\trforum}[1]{\href{https://forums.terraria.org/index.php?threads/#1}{\includegraphics[align=c, height=9pt]{figure/terrariaforum.png}}}
...
\else
	\newcommand{\wiki}[1]{#1\index{#1}\footnote{\url{https://terraria.wiki.gg/zh/wiki/#1}}}
	\newcommand{\wikii}[2]{#2\index{#2}\footnote{\url{https://terraria.wiki.gg/zh/wiki/#1}}}
	...
	\NewDocumentCommand{\youku}{m}{\href{https://v.youku.com/v_show/id_#1}{\tcbox[on line, boxsep=1pt, colframe=youkudeeppink, colback=white, left=0pt, right=0pt, top=0pt, bottom=0pt]{\includegraphics[align=c, height=9pt]{figure/github.pdf} \footnotesize\sffamily\textcolor{youkudeeppink}{#1}}}}
\fi
